...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Sign in · GoalChaser.co</title>
    ...
    <body class="bg-gray-50 text-gray-900 antialiased">
        <div class="mx-auto mt-20 max-w-sm px-4">
            ...
            <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <a href="{{ route('google.redirect') }}" class="flex w-full items-center justify-center gap-3 rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors">
                ...
                <div class="mt-6 text-center text-sm text-gray-500">
                    ...
                    <a href="{{ route('register') }}" class="font-semibold text-blue-600 hover:text-blue-700">Sign up</a>
                </div>
            </div>
        </div>
    </body>
