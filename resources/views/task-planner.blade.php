...
<footer>
  <div class="footer-inner">
    <div class="footer-grid">
      ...
      <div class="footer-col">
        ...
        <ul>
          ...
          <li><a href="mailto:support@stride.best">support@stride.best</a></li>
          <li><a href="mailto:info@stride.best">info@stride.best</a></li>
        </ul>
      </div>
      <div class="footer-col">
        <h5>Legal</h5>
    ...
    <div class="footer-bottom">
      <span>© 2026 stride.best. All rights reserved.</span>
