...
<div class="max-w-2xl">
    <div class="rounded-xl border border-gray-200 bg-white p-6">
        <form method="POST" action="{{ route('admin.monetization.update') }}">
            ...
            <div class="space-y-6">
                <div>
                    <label for="per_minute_rate" class="block text-sm font-semibold text-gray-700 mb-2">Per-Minute Rate ($)</label>
                    <div class="relative">
                        ...
                        <input type="number" step="0.01" min="0.01" id="per_minute_rate" name="per_minute_rate"
                            ...
                            class="w-full pl-8 pr-4 py-3 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition font-semibold text-gray-900"
                            required>
                    </div>
                ...
                <div>
                    <label for="minimum_refill" class="block text-sm font-semibold text-gray-700 mb-2">Minimum Refill ($)</label>
                    <div class="relative">
                        <span class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 font-semibold">$</span>
            ...
            <div class="mt-8 flex items-center gap-4">
                <button type="submit"
                    class="inline-flex items-center gap-1.5 px-3 py-2 rounded-lg bg-primary text-white font-semibold hover:bg-primary-container transition-all active:scale-95 shadow-sm">
                    Save Settings
                </button>
            </div>
        </form>
        ...
        <div class="mt-8 p-4 rounded-lg bg-blue-50 border border-blue-200">
            <div class="flex items-start gap-3">
                ...
                <div>
                    <p class="text-sm font-semibold text-blue-800">Current Configuration</p>
