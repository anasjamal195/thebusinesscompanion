...
<div class="max-w-7xl">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div>
            <div class="rounded-xl border border-gray-200 bg-white p-6 space-y-5">
                <div class="flex items-center gap-4">
                    <div class="h-14 w-14 rounded-xl bg-primary/10 text-primary flex items-center justify-center">
                        <span class="material-symbols-outlined text-[20px]">call</span>
                    </div>
                    <div>
                        <div class="text-xs font-medium text-gray-500 uppercase tracking-wider">Call ID</div>
                ...
                <div>
                    <div class="text-xs font-medium text-gray-500 uppercase tracking-wider mb-2">User</div>
                    @if($call->user)
                        <a href="{{ route('admin.users.show', $call->user) }}" class="flex items-center gap-3 group">
                            ...
                            <div>
                                <div class="text-sm font-semibold text-gray-900 group-hover:text-primary transition-colors">{{ $call->user->name }}</div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <span class="inline-flex items-center gap-1.5 mt-1 px-2.5 py-1 rounded-lg text-xs font-semibold
                ...
                @if($call->recording_url)
                    <div class="h-px bg-gray-200"></div>
                    <div>
                        <div class="text-xs font-medium text-gray-500 uppercase tracking-wider mb-2">Recording</div>
        ...
        <div class="lg:col-span-2">
            <div class="rounded-xl border border-gray-200 bg-white p-6 h-full flex flex-col">
                ...
                @if($call->transcript)
                    <div class="bg-gray-50 rounded-xl p-5 border border-gray-200 flex-1 overflow-y-auto max-h-[600px]">
        ...
        @if($call->metadata)
            <div class="lg:col-span-1">
                <div class="rounded-xl border border-gray-200 bg-white p-6">
                    ...
                    <div class="bg-gray-50 rounded-xl p-5 border border-gray-200 overflow-x-auto">
