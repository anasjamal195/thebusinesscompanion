        ...
        <table class="w-full">
            <thead>
                <tr class="bg-gray-50 border-b border-gray-200">
                    ...
                    <th class="text-left text-[11px] font-semibold uppercase tracking-wider text-gray-500 px-5 py-3.5">Date Joined</th>
            ...
            <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-5 py-4">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="text-sm font-semibold text-gray-900">{{ $entry->email }}</span>
                            </div>
                        </td>
                        <td class="px-5 py-4 text-sm text-gray-500">{{ $entry->created_at->format('M d, Y h:i A') }}</td>
                ...
                @empty
                    <tr>
                        <td colspan="3" class="px-5 py-8 text-center text-sm text-gray-500">No waitlist entries.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
